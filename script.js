...
let test = function  (m,n) {  
    ...
    let nums = function (m,n)  {
            return n+m
        }
        
        console.log(nums (20,9))
 ...
 let personM = {
    ...
    lastName: "KH",
    fullName() {
         return ( "ფუნქცია აბრუნებს სრულ სახელს - "  + this.firstName +  this.lastName  + " და ფუნქციის გარეთ ბეჭდავს")
    }
 }
 console.log(personM.fullName())
